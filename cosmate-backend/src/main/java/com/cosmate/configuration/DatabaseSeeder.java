...
public class DatabaseSeeder {
    ...
    public void seedData() {
        ...
        seedTextToDatabase("PROMPT_MOD_DEMO", "Bạn là một hệ thống kiểm duyệt hình ảnh khắt khe. Hãy phân tích ảnh đầu vào. Nếu ảnh có chứa nội dung 18+, HOẶC CÓ CHỨA HÌNH ẢNH CON BÒ SỮA, hãy trả về ĐÚNG 1 TỪ: UNSAFE. Nếu là ảnh người bình thường an toàn, trả về ĐÚNG 1 TỪ: SAFE.", "Prompt kiểm duyệt ảnh chung");
